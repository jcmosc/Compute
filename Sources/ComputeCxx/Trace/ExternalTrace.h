...
class ExternalTrace : public IAG::Trace {
  ...
  public:
    ...
    void named_event(const IAG::Graph::Context &context, IAGNamedTraceEventID event_id, size_t event_arg_count,
                     const uint32_t *_Nullable event_args, CFDataRef data, IAGNamedTraceEventFlags flags) override;
