...
func reprintingStandardOutput<Target, Result>(
...
/// Additionally writes any data written to standard error into the given output stream.
///
/// - Parameters:
///   - output: An output stream to receive the standard error text
///   - encoding: The encoding to use when converting standard output into text.
///   - body: A closure that is executed immediately.
/// - Returns: The return value, if any, of the `body` closure.

func reprintingStandardError<Target, Result>(
