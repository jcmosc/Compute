...
#define platform_log_info(log, format, ...) _platform_log_impl(log, PLATFORM_LOG_TYPE_INFO, (format), ##__VA_ARGS__)

#define platform_log_error(log, format, ...) _platform_log_impl(log, PLATFORM_LOG_TYPE_ERROR, (format), ##__VA_ARGS__)

#define platform_log_fault(log, format, ...) _platform_log_impl(log, PLATFORM_LOG_TYPE_FAULT, (format), ##__VA_ARGS__)
