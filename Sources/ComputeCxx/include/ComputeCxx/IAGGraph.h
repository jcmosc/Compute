...
CFTypeID IAGGraphGetTypeID(void) IAG_SWIFT_NAME(getter:Graph.typeID());

// MARK: Graph Context

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGGraphRef IAGGraphCreate(void) IAG_SWIFT_NAME(Graph.init());

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGGraphRef IAGGraphCreateShared(IAGGraphRef _Nullable graph) IAG_SWIFT_NAME(Graph.init(shared:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGUnownedGraphContextRef IAGGraphGetGraphContext(IAGGraphRef graph) IAG_SWIFT_NAME(getter:Graph.graphContext(self:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphInvalidate(IAGGraphRef graph) IAG_SWIFT_NAME(Graph.invalidate(self:));

// MARK: User context

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
const void *_Nullable IAGGraphGetContext(IAGGraphRef graph) IAG_SWIFT_NAME(getter:Graph.context(self:));
...
bool IAGGraphBeginDeferringSubgraphInvalidation(IAGGraphRef graph)
    IAG_SWIFT_NAME(Graph.beginDeferringSubgraphInvalidation(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphEndDeferringSubgraphInvalidation(IAGGraphRef graph, bool was_deferring)
    IAG_SWIFT_NAME(Graph.endDeferringSubgraphInvalidation(self:wasDeferring:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphVerifyType(IAGAttribute attribute, IAGTypeID type) IAG_SWIFT_NAME(AnyAttribute.verifyType(self:type:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGGraphRef IAGGraphGetAttributeGraph(IAGAttribute attribute) IAG_SWIFT_NAME(getter:AnyAttribute.graph(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGAttributeInfo IAGGraphGetAttributeInfo(IAGAttribute attribute) IAG_SWIFT_NAME(getter:AnyAttribute.info(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGAttributeFlags IAGGraphGetFlags(IAGAttribute attribute) IAG_SWIFT_NAME(getter:AnyAttribute.flags(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphSetFlags(IAGAttribute attribute, IAGAttributeFlags flags)
    IAG_SWIFT_NAME(setter:AnyAttribute.flags(self:_:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
uint32_t IAGGraphAddInput(IAGAttribute attribute, IAGAttribute input, IAGInputOptions options)
    IAG_SWIFT_NAME(AnyAttribute.addInput(self:_:options:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGAttribute IAGGraphCreateIndirectAttribute(IAGAttribute attribute) IAG_SWIFT_NAME(AnyAttribute.createIndirect(self:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
IAGAttribute IAGGraphGetIndirectAttribute(IAGAttribute attribute) IAG_SWIFT_NAME(getter:AnyAttribute.source(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphSetIndirectAttribute(IAGAttribute attribute, IAGAttribute source)
    IAG_SWIFT_NAME(setter:AnyAttribute.source(self:_:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
bool IAGGraphHasValue(IAGAttribute attribute) IAG_SWIFT_NAME(getter:AnyAttribute.hasValue(self:));
...
void IAGGraphUpdateValue(IAGAttribute attribute, IAGGraphUpdateOptions options)
    IAG_SWIFT_NAME(AnyAttribute.updateValue(self:options:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
uint32_t IAGGraphPrefetchValue(IAGAttribute attribute) IAG_SWIFT_NAME(AnyAttribute.prefetchValue(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphInvalidateValue(IAGAttribute attribute) IAG_SWIFT_NAME(AnyAttribute.invalidateValue(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphInvalidateAllValues(IAGGraphRef graph) IAG_SWIFT_NAME(Graph.invalidateAllValues(self:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphSetUpdate(const void *update) IAG_SWIFT_NAME(Graph.setUpdate(_:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
const void *IAGGraphClearUpdate(void) IAG_SWIFT_NAME(Graph.clearUpdate());

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphCancelUpdate(void) IAG_SWIFT_NAME(Graph.cancelUpdate());

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
bool IAGGraphCancelUpdateIfNeeded(void) IAG_SWIFT_NAME(Graph.cancelUpdateIfNeeded());

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
bool IAGGraphUpdateWasCancelled(void) IAG_SWIFT_NAME(getter:Graph.updateWasCancelled());

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
uint64_t IAGGraphGetDeadline(IAGGraphRef graph) IAG_SWIFT_NAME(getter:Graph.deadline(self:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphSetDeadline(IAGGraphRef graph, uint64_t deadline) IAG_SWIFT_NAME(setter:Graph.deadline(self:_:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
bool IAGGraphHasDeadlinePassed(void) IAG_SWIFT_NAME(getter:Graph.hasDeadlinePassed());

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphSetNeedsUpdate(IAGGraphRef graph) IAG_SWIFT_NAME(Graph.setNeedsUpdate(self:));
...
IAG_EXPORT
IAG_REFINED_FOR_SWIFT
bool IAGGraphCurrentAttributeWasModified(void) IAG_SWIFT_NAME(getter:AnyAttribute.currentWasModified());
...
CFTypeRef _Nullable IAGGraphDescription(IAGGraphRef _Nullable graph, CFDictionaryRef options)
    IAG_SWIFT_NAME(Graph.description(_:options:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphArchiveJSON(const char *_Nullable filename) IAG_SWIFT_NAME(Graph.archiveJSON(name:));

IAG_EXPORT
IAG_REFINED_FOR_SWIFT
void IAGGraphArchiveJSON2(const char *filename, bool exclude_values)
    IAG_SWIFT_NAME(Graph.archiveJSON(name:excludeValues:));
#endif
