...
IAGComparisonMode mode_for_type(const swift::metadata *_Nullable type, IAGComparisonMode default_mode);
...
ValueLayout fetch(const swift::metadata &type, IAGComparisonOptions options, uint32_t priority);
