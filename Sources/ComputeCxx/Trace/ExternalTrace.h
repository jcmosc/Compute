...
class ExternalTrace : public AG::Trace {
  ...
  public:
    ...
    ExternalTrace(uint64_t id, AGTrace *trace, void *context) : AG::Trace(id), _trace(trace), _context(context) {};
    ...
    void set_edge_pending(AG::data::ptr<AG::Node> node, uint32_t input_index, bool pending) override;
