...
typedef struct AGTrace {
    ...
    void (*_Nullable begin_update_subgraph)(void *_Nullable context, AGSubgraphRef subgraph);
    void (*_Nullable end_update_subgraph)(void *_Nullable context, AGSubgraphRef subgraph);
    void (*_Nullable begin_update)(void *_Nullable context, AGAttribute attribute);
    void (*_Nullable end_update)(void *_Nullable context, bool changed);
    void (*_Nullable begin_update_attribute)(void *_Nullable context);
    void (*_Nullable end_update_attribute)(void *_Nullable context);
    ...
    void (*_Nullable begin_modify)(void *_Nullable context);
    void (*_Nullable end_modify)(void *_Nullable context);
    ...
    void (*_Nullable added_attribute)(void *_Nullable context);
    void (*_Nullable add_edge)(void *_Nullable context);
    void (*_Nullable remove_edge)(void *_Nullable context);
    void (*_Nullable set_edge_pending)(void *_Nullable context);

    void (*_Nullable set_dirty)(void *_Nullable context);
    void (*_Nullable set_pending)(void *_Nullable context);
    void (*_Nullable set_value)(void *_Nullable context);
    void (*_Nullable mark_value)(void *_Nullable context);

    void (*_Nullable added_indirect_attribute)(void *_Nullable context, AGAttribute attribute);
    void (*_Nullable set_source)(void *_Nullable context, AGAttribute attribute);
    void (*_Nullable set_dependency)(void *_Nullable context, AGAttribute attribute);
